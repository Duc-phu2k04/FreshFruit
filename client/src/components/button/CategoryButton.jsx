...
export default function CategoryDropdown() {
    ...
    return (
        ...
        >
            ...
            <button className="bg-green-800 hover:bg-green-700 text-white font-medium py-3 px-6 rounded-lg flex items-center space-x-2 cursor-pointer">
                <FaList />
            ...
            {open && (
                <ul className="absolute left-0 mt-2 w-60 bg-white border rounded-md shadow-lg z-10 text-gray-800">
